...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df[filtered_df['Launch Site']==entered_site], names='class', 
...
def get_pie_chart(entered_site,slider):
    ...
    low, high = slider
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df[(filtered_df['Payload Mass (kg)'] > low) & (filtered_df['Payload Mass (kg)'] < high)],
        ...
        fig = px.scatter(filtered_df[(filtered_df['Launch Site']==entered_site) & (filtered_df['Payload Mass (kg)'] > low) & (filtered_df['Payload Mass (kg)'] < high)],
        x='Payload Mass (kg)', 
        y='class', color='Booster Version Category',
        title='title')
        return fig
